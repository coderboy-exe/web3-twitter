...
const style = {
    ...
    profileImg: `height-12 w-12 rounded-full`,
...
const Sidebar = ({ initialSelected = 'House' }) => {
  ...
  return (
    <div className={style.wrapper}>
        ...
        <div className={style.navContainer}>
            ...
            <div className={style.tweetBtn}>Mint</div>
        </div>
        ...
        <div className={style.profileBtn}>
          ...
          <div className={style.profileRight}>
            <div className={style.details}>
              <div className={style.name}>code_shinobi</div>
              <div className={style.handle}>@0x86...5f2df</div>
            </div>
